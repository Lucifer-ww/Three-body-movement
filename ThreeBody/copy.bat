...
copy "..\..\..\VS2008\Modules\Release\DemoDll\ThreeBody.dll" ".\dll\"

copy "..\..\..\VS2008\Modules\Release\SampleWin.exe" ".\ThreeBody.exe"
copy "..\..\..\VS2008\Modules\Release\WindowFullScreen.exe" ".\ThreeBodyFS.exe"
